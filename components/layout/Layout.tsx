...
export const Layout: React.FC<LayoutProps> = ({
  ...
  // Default sidebar state: Check localStorage, fallback to true for desktop
              ...
              <div className="flex items-center gap-2 md:gap-3 animate-in fade-in slide-in-from-right-4 duration-300 shrink-0">
                ...
                <div className="flex items-center gap-1">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="w-8 h-9 text-slate-500 hover:text-slate-900 border border-slate-200 bg-white"
                    onClick={() => {
