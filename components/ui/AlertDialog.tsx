...
export const AlertDialogContent: React.FC<{
  ...
  <div
    className={`relative z-201 grid w-full max-w-lg scale-100 gap-4 border bg-white p-6 opacity-100 shadow-lg animate-in fade-in-90 zoom-in-90 sm:rounded-lg md:w-full sm:max-w-106.25 m-4 ${className}`}
  >
    {children}
  </div>
);
