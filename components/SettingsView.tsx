      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200 pb-6">
        <div>
          ...
          <p className="text-slate-500 mt-2 text-lg">
            Quản lý tài nguyên vận hành và mạng lưới tuyến đường.
          </p>
        </div>
        <div className="flex gap-4">
          <div className="bg-white px-5 py-3 rounded-xl border border-slate-200 shadow-sm flex flex-col min-w-35">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-sm font-medium text-green-600 bg-green-50 px-1.5 rounded">
                {activeBusesCount} hoạt động
              </span>
            </div>
          </div>
          <div className="bg-white px-5 py-3 rounded-xl border border-slate-200 shadow-sm flex flex-col min-w-35">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-sm font-medium text-blue-600 bg-blue-50 px-1.5 rounded">
                {activeRoutesCount} khai thác
              </span>
            </div>
          </div>
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  ...
                  <div className="p-5 flex justify-between items-start">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <Badge
                          variant={route.isEnhanced ? "warning" : "default"}
                          className={
                            route.isEnhanced
                        ...
                        >
                          {route.isEnhanced ? (
                            <Zap size={10} className="mr-1 fill-amber-700" />
                          ) : null}
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-xs text-slate-500">
                          <span className="truncate max-w-25 font-medium">
                            {route.origin}
                          </span>
            ...
            <button
              ...
              className="group relative rounded-2xl border-2 border-dashed border-slate-200 hover:border-primary/50 hover:bg-primary/5 transition-all flex flex-col items-center justify-center min-h-55 text-slate-400 hover:text-primary gap-3"
            >
                ...
                <div className="flex flex-col md:flex-row items-start gap-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-500 mb-6 leading-relaxed max-w-3xl">
                      ...
                      <strong>Sơ đồ ghế (Trips)</strong>. Tự động phát hiện ghế
                      bị trùng giữa 2 số điện thoại và giữ lại đơn có thanh toán
                      cao hơn. Giải phóng các "ghế ma" không có đơn hàng thực
                      tế.
                    </p>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-4 items-center">
                      <Button
                        ...
                        className="bg-emerald-600 hover:bg-emerald-700 h-12 px-8 font-bold text-base shadow-lg shadow-emerald-500/20"
                      >
                        {isFixingPayments ? (
                          <>
                            <Loader2 className="animate-spin mr-2" size={18} />
                    ...
                    <div className="bg-emerald-50 rounded-2xl border border-emerald-200 overflow-hidden">
                      ...
                      <div className="max-h-75 overflow-y-auto">
                        {paymentMaintenanceResults.logs.length === 0 ? (
                          <div className="p-12 text-center text-slate-400 italic font-medium">
                            Hệ thống tài chính sạch. Không tìm thấy thanh toán
                            lỗi nào.
                          </div>
                        ) : (
                          <table className="w-full text-sm text-left">
